...
<!--  LocalWords:  API Roland's AudioContext sampleRate png osc HiHat
 -->
<!--  LocalWords:  createOscillator currentTime setTimeout createGain
 -->
<!--  LocalWords:  setValueAtTime exponentialRampToValueAtTime url js
 -->
<!--  LocalWords:  AudioParam defaultValue linearRampToValueAtTime
 -->
<!--  LocalWords:  bufferSize getChannelData createBuffer noiseBuffer
 -->
<!--  LocalWords:  noiseFilter highpass noiseEnvelope GainNode onload
 -->
<!--  LocalWords:  oscEnvelope BufferSource sampleLoader responseType
 -->
<!--  LocalWords:  XMLHttpRequest arraybuffer decodeAudioData OGG WAV
 -->
<!--  LocalWords:  hihat WAAClock Dilla synthesisers bpm setInterval
 -->
<!--  LocalWords:  Synth
 -->
