...
<figure block="figure">
	<img elem="media" src="{{ page.id }}/native-video-controls.jpg" alt="Native browser video controls">
	<figcaption elem="caption">Figure 1: Native browser video controls across different browsers</figcaption>
</figure>
...
<figure block="figure">
	<img elem="media" src="{{ page.id }}/dark-player-shot.jpg" alt="Video player screenshot">
	<figcaption elem="caption">Figure 1: Native browser video controls across different browsers</figcaption>
</figure>
...
<figure block="figure">
	<img elem="media" src="{{ page.id }}/smalldark-child-theme.jpg" alt="Smalldark child theme">
	<figcaption elem="caption">Figure 3: the Smalldark child theme in action</figcaption>
</figure>
