...
<figure block="figure" id="figure1">
	<img elem="media" src="{{ page.id }}/figure1.png" alt="diagram showing multiple callback functions being queued up">
	<figcaption elem="caption">Figure 1: If your callback functions take longer than your timers, enqueuing of multiple callback functions can choke up the browser.</figcaption>
</figure>
...
<figure block="figure" id="figure2">
	<img elem="media" src="{{ page.id }}/figure2.png" alt="diagram showing frames in an animation being skipped, but everything still being drawn">
	<figcaption elem="caption">Figure 2: Skipped frames can lead to higher CPU usage and battery consumption, and sometimes even choppy animations</figcaption>
</figure>
