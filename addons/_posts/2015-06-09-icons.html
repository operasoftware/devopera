...
<h2>Contents</h2>
  ...
  <p><img src="/static/images/01_simplicity.png" alt="good examples of icons - simple elegant and/or playful" class="img-polaroid" ></p>
  <p class="comment">Figure 1. Simple, elegant and/or playful icons.</p>
  ...
  <p><img src="/static/images/02_cleanshape.png" alt="image showing good and bad examples of icon shapes - you should go for a single clear shape in the center of the icon" class="img-polaroid"></p>
  ...
  <p><img src="/static/images/03_shadow.png" alt="an image showing good and bad examples of gradients and perspective" class="img-polaroid"></p>
  ...
  <div class="note" style="margin: 25px;">
    ...
    <p><img src="/static/images/04_dontuse.png" alt="examples of system icons and software vendor icons that you should not use" class="img-polaroid"></p>
  ...
  <p><img src="/static/images/05_scaling.png" alt="An image showing good and bad examples of scaling an image down to a small size" class="img-polaroid"></p>
  ...
  <ol>
    <li>Icons should be scaled nicely (no deformation, blurring or loss of intended details).<br><img src="/static/images/06_do_dont_blur.png" alt="Scaling and blur" class="img-polaroid"></li>
    <li>Icon edges should be clean (no blur on straight lines and no pixeled corners).<br><img src="/static/images/07_do_dont_grid.png" alt="Clean edges" class="img-polaroid"></li>
    <li>Icons with transparent backgrounds must be centered. The icon must not conflict with the Opera UI button.<br><img src="/static/images/08_do_dont_center.png" alt="Centered backgrounds" class="img-polaroid"></li>
    <li>Icons should be anti-aliased or perfectly pixelated.<br><img src="/static/images/09_do_dont_pixel.png" alt="Anti-aliasing and pixellation" class="img-polaroid"></li>
    <li>Icons must not be completely white, and must not lose their coherence on a white background or on the Opera toolbar chrome.<br><img src="/static/images/10_do_dont_white.png" alt="Not completely white background" class="img-polaroid"></li>
    <li>Icons should have a background or fill the space allotted to them. They should not occupy much less than 85% of the field.<br><img src="/static/images/11_do_dont_back.png" alt="Fill space or use background" class="img-polaroid"></li>
  </ol>
  ...
  <p><img src="/static/images/12_wingdings_win7.png" alt="Wingdings in Windows 7" class="img-polaroid"><img src="/static/images/13_webdings_osx.png" alt="Webdings in OSX" class="img-polaroid"></p>
  <p class="comment">Figure 6: The Wingdings font cheats you right through the laborious task of creating something unique.</p>
  ...
  <p><img src="/static/images/14_texttool.png" alt="The text tool button" class="img-polaroid"></p>
  ...
  <p><img src="/static/images/15_wingdings.png" alt="Click on the image for the full resolution" class="img-polaroid"></p>
  <p class="comment">Figure 8: Use a font for quickly applying an icon shape to your icon.</p>
  ...
  <p><img src="/static/images/16_converttoshape.png" alt="Make a vector shape of your text layer to fine tune the icon shape" class="img-polaroid"></p>
  <p class="comment">Figure 9: Converting the text to a vector shape will provide you with a fine grained control of it.</p>

  <p><img src="/static/images/17_shapezoomed.png" alt="The resulting shape with vector outlines" class="img-polaroid"></p>
  <p class="comment">Figure 10: An enlarged view of your text item turned vector shape.</p>

  <p><img src="/static/images/18_shapelayer.png" alt="The resulting shape layer" class="img-polaroid"></p>
  ...
  <p><img src="/static/images/19_place_reference.png" alt="Click on the image for the full resolution" class="img-polaroid"></p>
  ...
  <p><img src="/static/images/20_place_values.png" alt="The transform input fields after new input" class="img-polaroid"></p>
  ...
  <p><img src="/static/images/21_noblur.png" alt="Perfect fit!" class="img-polaroid"></p>
  <p class="comment">Figure 14: The icon details are perfectly matching the pixel grid.</p>
  ...
  <p><img src="/static/images/22_copytransform.png" alt="Copy/paste/scale to fit the small default background shape" class="img-polaroid"></p>
  <p class="comment">Figure 15: Duplicate the icon shape layer and move and scale it to fit the 48 px background shape.</p>
  ...
  <p><img src="/static/images/23_mismatch.png" alt="Vector paths do not fit pixel grid" class="img-polaroid"></p>
  <p class="comment">Figure 16: The vector paths do not fit the pixel grid.</p>

  <h3 id="sharpvectors2">Pixel sharp vectors, Part 2</h3>

  <p><img src="/static/images/24_directselect.png" alt="Direct Selection Tool" class="img-polaroid"></p>
  <p class="comment">Figure 17: Direct Selection Tool.</p>
  ...
  <p><img src="/static/images/25_nudge.png" alt="Left edge vector points selected" class="img-polaroid"></p>
  <p class="comment">Figure 18: Left edge vector points selected.</p>
  ...
  <div class="note" style="margin: 25px;">
    ...
    <p><img src="/static/images/26_nosnap.png" alt="Turn off vector snapping" class="img-polaroid"> <img src="/static/images/27_10pxgrid.png" alt="Make new gridlines" class="img-polaroid"></p>
    <p class="comment">Figure 19: Turn off vector snapping and make new gridlines.</p>
  </div>
  ...
  <p><img src="/static/images/28_nudged.png" alt="Straight lines matched" class="img-polaroid"></p>
  <p class="comment">Figure 20: Straight lines matched.</p>
  ...
  <p><img src="/static/images/29_delete_points.png" alt="Delete Anchor Point Tool" class="img-polaroid"></p>
  <p class="comment">Figure 21: Delete Anchor Point Tool.</p>

  <p><img src="/static/images/30_deleted.png" alt="Simplified shape" class="img-polaroid"></p>
  <p class="comment">Figure 22: Simplified shape.</p>
  ...
  <p><img src="/static/images/31_cutout.png" alt="Transforming cut-outs" class="img-polaroid"></p>
  <p class="comment">Figure 23: Transforming cut-outs.</p>
  ...
  <p><img src="/static/images/32_19px.png" alt="The 19x19 px icon" class="img-polaroid"></p>
  <p class="comment">Figure 24: The 19x19 px icon.</p>

  <p><img src="/static/images/33_16px.png" alt="The 16x16 px icon" class="img-polaroid"></p>
  <p class="comment">Figure 25: The 16x16 px icon.</p>
  ...
  <p><img src="/static/images/34_palettelayer.png" alt="Select layer style from palette" class="img-polaroid"></p>
  <p class="comment">Figure 26: Copying the layer style of a palette gradient color.</p>

  <p>Your icon should now look something like this and be ready for export:</p>

  <p><img src="/static/images/35_pasteeffect.png" alt="Finished icons" class="img-polaroid"></p>
  <p class="comment">Figure 27. Final icons ready for export.</p>
  ...
  <p><img src="/static/images/36_export.png" alt="Exporting" class="img-polaroid"></p>
  <p class="comment">Figure 28: Exporting.</p>
