...
Whenever you switch to next audio/video source with Java Script, make sure to destroy current audio/video element, and create new one. Without this some devices may have problems playing new audio/video source, especially if the format is different than previously played.
