...
<p><img src="http://forum-test.oslo.osa/kirby/content/articles/718-head-tracking-with-webrtc/head-tracking-demo.jpg" alt="an image of the headtracking video demonstration in action - user using their head to move around a 3D object on screen" /></p>
...
<p><img src="http://forum-test.oslo.osa/kirby/content/articles/718-head-tracking-with-webrtc/figure3d.png" alt="how the head tracking process works - the textual explanation below explains this in detail" /></p>
...
<p><img src="http://forum-test.oslo.osa/kirby/content/articles/718-head-tracking-with-webrtc/fov_56_70.png" alt="An illustration of how different fields of view affect head position in face tracking" /></p>
...
<p><img src="http://forum-test.oslo.osa/kirby/content/articles/718-head-tracking-with-webrtc/trig03.png" alt="a simple trigonometry illustration to show how we calculate the head-camera distance" /></p>
...
<p><img src="http://forum-test.oslo.osa/kirby/content/articles/718-head-tracking-with-webrtc/offaxisFigure.png" alt="diagram showing the concept of off-axis view" /></p>
...
<p><img src="http://forum-test.oslo.osa/kirby/content/articles/718-head-tracking-with-webrtc/i3D-demo.jpg" alt="i3D is an iPad app that uses head tracking to pan around a 3D environment" /></p>
...
<p><a href="mathml.html"><img src="http://forum-test.oslo.osa/kirby/content/articles/718-head-tracking-with-webrtc/mathml1.png" /></a></p>

<p>which gives us:</p>

<p><a href="mathml.html"><img src="http://forum-test.oslo.osa/kirby/content/articles/718-head-tracking-with-webrtc/mathml2.png" /></a></p>
...
<p><a href="mathml.html"><img src="http://forum-test.oslo.osa/kirby/content/articles/718-head-tracking-with-webrtc/mathml3.png" /></a></p>

<p>However, this is the same for pixels, so:</p>

<p><a href="mathml.html"><img src="http://forum-test.oslo.osa/kirby/content/articles/718-head-tracking-with-webrtc/mathml4.png" /></a></p>

<p>And this gives us:</p>

<p><a href="mathml.html"><img src="http://forum-test.oslo.osa/kirby/content/articles/718-head-tracking-with-webrtc/mathml5.png" /></a></p>

<p>Inserting this, we get:</p>

<p><a href="mathml.html"><img src="http://forum-test.oslo.osa/kirby/content/articles/718-head-tracking-with-webrtc/mathml6.png" /></a></p>
