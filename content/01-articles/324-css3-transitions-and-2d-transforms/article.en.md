...
<p>The initial <code>transform-origin</code> value is <var>50% 50%</var> which is the centre of the element&#x2014;50% from the left of the element and 50% from the top of the element. The origin can be specified using either a length (in the regular CSS units), a percentage or the keywords <var>left</var>, <var>center</var> or <var>right</var> (for the X co-ordinate) and <var>top</var>, <var>center</var> or <var>bottom</var> for the Y coordinate.</p> 
