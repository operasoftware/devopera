...
context.strokeRect(30, 25,  90, 60);</code></pre>
    ...
    <p>An example is in order - the following code will <a href="http://www.robodesign.ro/coding/canvas-primer/20081208/example-triangle.html">draw a triangle</a>:</p>
