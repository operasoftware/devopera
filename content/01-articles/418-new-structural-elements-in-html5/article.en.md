...
Text:
	...
	<!--  
	 ...
	 <p>Keep the sample page open in a separate tab as you read through the article &#x2014; you&#39;ll want to refer back to it.</p>
...
&lt;/footer&gt;</code></pre>
      ...
      <p class="note">Note: You are not restricted to one header and footer per page &#x2014; you could have a page containing multiple articles, and have a header and footer per article.</p>
...
<pre><code>&lt;figure&gt;
  &lt;img src=&quot;http://forum-test.oslo.osa/kirby/content/articles/418-new-structural-elements-in-html5/pwei.png&quot; alt=&quot;Old poppies logo&quot; /&gt;
  &lt;figcaption&gt;
