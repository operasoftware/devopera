...
authors:
- mathias-bynens
intro: 'Opera 24 (based on Chromium 37) for [Mac and Windows](http://www.opera.com/computer) is out! To find out what’s new for users, see our [Desktop Team blog](http://blogs.opera.com/desktop/2014/09/browse-faster-opera-24-desktop-with-tab-preview/). Here’s what it means for web developers.'
tags:
- html
- css
- javascript
...
Opera 24 (based on Chromium 37) for [Mac and Windows](http://www.opera.com/computer) is out! To find out what’s new for users, see our [Desktop Team blog](http://blogs.opera.com/desktop/2014/09/browse-faster-opera-24-desktop-with-tab-preview/). Here’s what it means for web developers.
