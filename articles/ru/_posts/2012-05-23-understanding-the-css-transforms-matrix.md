...
<figure id="figure-1">
	<img src="1.gif" alt="Сетка с цифрами 3×3: верхний ряд 1, 2, 8; средний ряд: 10, 3, 9; нижний ряд: 7, 4, 0">
...
<figure id="figure-2">
	<img src="2.gif" alt="Пример локальной системы координат">
...
<figure id="figure-3">
	<img src="4.gif" alt="Пример локальной системы координат">
...
<figure id="figure-4">
	<img src="3.gif" alt="Сетка с цифрами 3×3. Верхний ряд: a, c, e; средний ряд: b, d, f; нижний ряд: 0, 0, 1">
...
<figure id="figure-5">
	<img src="5.gif" alt="При умножении матрицы на вектор, результат это сумма результатов каждого элемента матрицы, помноженного на соответствующий элемент вектора">
...
<figure id="figure-6">
	<img src="6.gif" alt="Матрица сдвига">
...
<figure id="figure-7">
	<img src="4b.png" alt="Объект с глобальными координатами (0,0)">
...
<figure id="figure-8">
	<img src="7.gif" alt="Вычисление трансформации сдвига">
...
<figure id="figure-9">
	<img src="7b.png" alt="Наш объект после применения трансформации">
...
<figure id="figure-10">
	<img src="8.gif" alt="Матрица 4×4 для масштабирования">
...
<figure id="figure-11">
	<img src="9b.png" alt="Объект 300×300 пикселей после применения трансформации масштабирования">
...
<figure id="figure-12">
	<img src="9.gif" alt="Вычисление трансформации масштабирования">
...
<figure id="figure-13">
	<img src="10.gif" alt="Вычисление матрицы составной трансформации">
...
<figure id="figure-14">
	<img src="10b.png" alt="Наш объект 300×300 пикселей после масштабирования и поворота">
...
<figure id="figure-15">
	<img src="11.gif" alt="Применение трансформации">
