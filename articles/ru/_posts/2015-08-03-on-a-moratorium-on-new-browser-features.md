---
title: 'О моратории на новые браузерные функции, предложенном ППК'
authors:
- bruce-lawson
intro: 'Разработчик ППК призывает к мораторию на новые браузерные функции. Мы объясняем, почему не согласны.'
tags:
- offline
- service-workers
language: ru
...
Во многом мы, специалисты Opera по связям с разработчиками, разделяем его боль. Каждому из нас знакомо чувство, когда по возвращении из отпуска мы не можем понять беседы в твиттере о спецификации, появившейся в тот недавний вечер, когда мы нежились у бассейна/покоряли сердца зажигательной бачатой/бродили по древним руинам/отрывались в Магалуфе/выражали смайликами-эмодзи в виде какашки своё сожаление об излишке съеденных накануне `U+1F364` (зачеркните нужное в зависимости от того, кто вы — Брюс, Шветанк, Матиас, Вадим или Андреас).
...
Также при всём уважении мы не согласны с ППК, что добавление похожего на нативные приложения пользовательского опыта и защита простоты, URL-ов и общедоступности как фундаментальных ценностей веба однозначно противоречат друг другу.
...
Если взять огромную кастрюлю и кипятить в ней веб все выходные напролет, периодически снимая пену из ютьюбовских комментов, порнухи и фоточек мерзких котиков (тавтология?), то, заглянув под крышку в воскресенье вечером, вы найдете в остатке лишь URL-ы (или URI-шки, или URN-ки... неужели кого-то заботит эта разница?).
...
* Одновременно с нашей публикацией, евангелист Google Chrome Джейк Арчибальд опубликовал статью [«Если мы остановимся, мы двинемся вспять»](https://jakearchibald.com/2015/if-we-stand-still-we-go-backwards/) ([ее перевод](http://css-live.ru/articles/esli-my-ostanovimsya-my-dvinemsya-vspyat.html)) на эту же тему.
* Пол Кинлэн написал статью [«SLICE: the web»](https://paul.kinlan.me/slice-the-web/) о положительных аспектах веба как платформы для пользователей и разработчиков _(прим. перев.: SLICE — аббревиатура, буквы которой обозначают безопасность, возможность ссылаться, индексируемость, возможность быстрой сборки из готовых частей и «эфемерность», т.е. способность не занимать ресурсы постоянно; по-русски, наверное, можно передать как «безопасный, линкуемый, индексируемый, компонуемый, исчезающий» — БЛИКИ)_;
...
* Мариано Виола написал статью [«Мобильный веб не сломался… пока еще»](http://www.marianoviola.com/blog/mobile-web-isnt-broken-yet)
* [Размышления о браузерных новинках, функциональной совместимости, мастерстве и будущем веба](http://www.aaron-gustafson.com/notebook/ramblings-on-new-browser-features-interoperability-craft-and-the-future-of-the-web/) — взгляд Аарона Густафсона (Microsoft) на это всё.
