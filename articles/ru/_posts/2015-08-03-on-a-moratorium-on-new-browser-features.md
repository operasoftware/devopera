...
HTML5 это изменил, и теперь все браузеры, достойные пожатия угловой скобки, получают одну и ту же DOM вне зависимости от валидности разметки. Это дало колоссальное улучшение совместимости, что радует потребителей и сберегает сотни километров разработческих нервов.
...
Добавлено 4 августа: Одновременно с нашей публикацией, евангелист Google Chrome Джейк Арчибальд опубликовал статью [«Если мы остановимся, мы двинемся вспять»](https://jakearchibald.com/2015/if-we-stand-still-we-go-backwards/) ([ее перевод](http://css-live.ru/articles/esli-my-ostanovimsya-my-dvinemsya-vspyat.html)) на эту же тему.
