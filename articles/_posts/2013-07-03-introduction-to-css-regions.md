...
<figure id="figure-1">
	<img src="/articles/introduction-to-css-regions/regions-1.png" alt="A css regions example showing a complicated layout with content flowed into different boxes">
