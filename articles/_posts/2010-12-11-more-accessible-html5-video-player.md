...
<figure class="figure">
	<img src="{{ page.id }}/opera-video-controls.png" alt="Native Browser Video controls in Opera 10">
	<figcaption>Figure 1: Native browser video controls in Opera 10.63, with the volume button focused</figcaption>
</figure>
...
<figure class="figure">
	<img src="{{ page.id }}/barebones-video-controls.png" alt="Video player controls, with the new markup">
	<figcaption>Figure 2: Custom video player controls, with the new markup</figcaption>
</figure>
