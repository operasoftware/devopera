...
<figure block="figure">
	...
	<figcaption elem="caption" markdown="span">Screenshot of the [original website][1]</figcaption>
</figure>
...
So ideas bloomed, but almost as importantly: Some things entirely failed to catch on. They just weren’t right. [Tim’s original proposal for HTML][3] contained only 20 tags and more than a third of them (7) weren’t ultimately standardized.
...
Then, suddenly, browsers began developing again. Library makers got involved with Web standards. In 2010, [Remy Sharp introduced the idea of polyfills][4] and more recently browsers began auto-updating. The whole game was dramatically shifting.

### Enter the Extensible Web

By 2011, the community at large seemed dissatisfied and a conversation began. By 2013, this conversation led to an agreement on expression of core philosophy agreed to by 21 people called [The Extensible Web Manifesto][5].
...
This one didn’t come from Houdini itself, so it already has an editor and a [rough draft][17], but Houdini expands its scope a bit. Its aim is to make it possible for authors to create simple aliases for selectors or even wholly new pseudo-classes.
...
A lot of times the thing that you need to calculate require context and information which is not currently available to you. Take, for example, drop-caps. Adobe worked hard on creating [dropcap.js][19] which is worth a look (including the linked blog post) if you want to understand the complexity and challenges and compromises we currently have to make to do something as “simple” as drop-caps. The Font-Metrics API would work on exposing the necessary information one would need to help fill things that involve font-oriented information.

#### Custom Layout

CSS has all kinds of crazy layout modes and still, it’s really hard to do some things that it shouldn’t be so hard to do — so, for example, we have alternative proposals like [Grid Stylesheets (GSS)][20] which use a constraint-based layout. Figuring out this stuff is hard and it takes an astoundingly inordinate amount of work to get it specified, correct and interoperable. Custom layouts will allow us to register a custom display value and own layout computations making whole classes of new proposals possible to figure out in the community and without impossibly complex barriers.
...
[2]: http://www.ted.com/talks/matt_ridley_when_ideas_have_sex
[3]: http://info.cern.ch/hypertext/WWW/MarkUp/Tags.html
[4]: https://remysharp.com/2010/10/08/what-is-a-polyfill
[5]: https://extensiblewebmanifesto.org/
[6]: http://html5doctor.com/interview-with-ian-hickson-html-editor/#appcache
[7]: https://fetch.spec.whatwg.org/
[8]: https://streams.spec.whatwg.org/
[9]: http://www.w3.org/TR/dom/#mutation-observers
[10]: https://slightlyoff.github.io/ServiceWorker/spec/service_worker/
[11]: http://w3c.github.io/webcomponents/spec/custom/
[12]: https://wiki.css-houdini.org/planning/sydney-2015
[13]: https://wiki.css-houdini.org/
[14]: https://lists.w3.org/Archives/Public/public-houdini/
[15]: https://github.com/w3c/css-houdini-drafts
[16]: http://esprima.org/
[17]: http://tabatkins.github.io/specs/css-aliases/index.html
[18]: https://the-pastry-box-project.net/bruce-lawson/2012-september-1
[19]: https://github.com/adobe-webplatform/dropcap.js
[20]: http://gridstylesheets.org/
