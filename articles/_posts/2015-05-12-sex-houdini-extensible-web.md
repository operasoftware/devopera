...
authors:
- brian-kardell
intro: 'To evolve the web and compete with native, we need a way to innovate and iterate faster - the Extensible Web principles, which have bought us Service Worker and Web Components. Project Houdini looks at how we can bruing extensibility to CSS, too.'
tags:
- CSS
- HTML
published: false
