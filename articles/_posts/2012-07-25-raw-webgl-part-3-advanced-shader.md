...
<figure block="figure" id="figure-1">
	<img elem="media" src="{{ page.id }}/figure1.png" alt="A canvas generated gradient going from green at the top left to red at the bottom right, with a large black square at the bottom left">
	<figcaption elem="caption">Figure 1: Our new shader is functional</figcaption>
</figure>
...
<figure block="figure" id="figure-2">
	<img elem="media" src="{{ page.id }}/figure2.png" alt="A canvas generated fractal">
	<figcaption elem="caption">Figure 2: We have generated a rather nice fractal</figcaption>
</figure>
...
<figure block="figure" id="figure-3">
	<img elem="media" src="{{ page.id }}/figure3.png" alt="A canvas generated fractal with smoother colouring in the background">
	<figcaption elem="caption">Figure 3: The background colour is now a smooth gradient!</figcaption>
</figure>
...
<figure block="figure" id="figure-4">
	<img elem="media" src="{{ page.id }}/figure4.png" alt="A canvas generated fractal with a beautiful coloured background gradient">
	<figcaption elem="media">Figure 4: This is much prettier</figcaption>
</figure>
...
<figure block="figure" id="figure-5">
	<img elem="media" src="{{ page.id }}/figure5.png" alt="A canvas generated fractal with inverted colours">
	<figcaption elem="caption">Figure 5: Inverted colours give our fractal a halo-type effect</figcaption>
</figure>
