...
Why did I use all of those "likely"s and "probably"s in the sections above?
...
Very much like it does when using the `sizes` algorithm, the browser goes over the
